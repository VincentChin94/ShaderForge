...
/////// Diffuse:
                ...
                float4 node_3765 = _Time + _TimeEditor;
                float node_8215 = sin((_Speed*node_3765.g));
                float node_6087 = (node_8215+1.0);
                float node_3933 = 0.0;
                float node_5770_if_leA = step(node_6087,node_3933);
                float node_5770_if_leB = step(node_3933,node_6087);
                float node_702 = (node_6087-lerp((node_5770_if_leA*node_3933)+(node_5770_if_leB*node_6087),node_6087,node_5770_if_leA*node_5770_if_leB));
                float node_4800_if_leA = step((((smoothstep( node_702, _SnowHeight, i.posWorld.g )*(step(node_702,i.posWorld.g)*step(i.posWorld.g,_SnowHeight)))+step(_SnowHeight,i.posWorld.g))*step(node_6087,dot(i.normalDir,float3(0,1,0)))),0.0);
                float node_4800_if_leB = step(0.0,(((smoothstep( node_702, _SnowHeight, i.posWorld.g )*(step(node_702,i.posWorld.g)*step(i.posWorld.g,_SnowHeight)))+step(_SnowHeight,i.posWorld.g))*step(node_6087,dot(i.normalDir,float3(0,1,0)))));
