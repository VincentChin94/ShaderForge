        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float node_5504 = saturate((v.normal*(normalize(_SnowDirection.rgb)*(-1.0))).g);
...
/////// Diffuse:
                ...
                float node_5504 = saturate((normalDirection*(normalize(_SnowDirection.rgb)*(-1.0))).g);
